...
class FlutterAudioVisualizer {
  ...
  /// 从外部传入 PCM 数据并计算 FFT（不创建播放器）
  static Future<bool> processBuffer(List<double> data) async {
    final bool success = await _methodChannel.invokeMethod('processBuffer', {'data': data});
    return success;
  }
}
