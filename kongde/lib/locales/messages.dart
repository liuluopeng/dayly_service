...
class Messages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'zh_CN': {
      ...
      'settings.theme': '主题',
      'settings.uiStyle': 'UI 风格',
      'settings.uiMaterial': 'Material Design',
      'settings.uiMaterialDesc': 'Google 标准的 Android 风格',
      'settings.uiWp10': 'Windows Phone 10',
      'settings.uiWp10Desc': '微软 Metro 风格扁平界面',
    ...
    'en_US': {
      ...
      'settings.uiMaterial': 'Material Design',
      'settings.uiMaterialDesc': 'Google standard Android style',
      'settings.uiWp10': 'Windows Phone 10',
      'settings.uiWp10Desc': 'Microsoft Metro flat style',
