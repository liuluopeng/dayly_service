...
class Messages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'zh_CN': {
      ...
      'menu.surroundListen': '环境监听',
      'surround.title': '环境监听',
      'surround.intro': '把麦克风采集的外界声音实时传到耳机，戴耳机时也能听到环境动静（如有人叫你）。',
      'surround.warning': '提示：请戴好耳机再开启，避免扬声器回授产生啸叫。',
      'surround.start': '开始监听',
      'surround.stop': '停止监听',
      'surround.pause': '暂停',
      'surround.resume': '继续',
      'surround.gain': '收音音量',
      'surround.listenHint': '监听中：外界声音已实时传入耳机',
      'surround.quickListening': '监听中 · 点击暂停',
      'surround.quickIdle': '未监听 · 点击开始',
      'surround.pausedHint': '已暂停 · 点击继续',
      'surround.startFailed': '启动失败: @error',
      'menu.tools': '工具函数',
    ...
    'en_US': {
      ...
      'menu.surroundListen': 'Surround Listen',
      'surround.title': 'Surround Listen',
      'surround.intro': 'Stream the microphone into your headphones in real time, so you can hear what is happening around you while wearing them.',
      'surround.warning': 'Wear headphones before starting to avoid feedback howling.',
      'surround.start': 'Start listening',
      'surround.stop': 'Stop listening',
      'surround.pause': 'Pause',
      'surround.resume': 'Resume',
      'surround.gain': 'Mic gain',
      'surround.listenHint': 'Listening: ambient sound is streaming to your headphones',
      'surround.quickListening': 'Listening · tap to pause',
      'surround.quickIdle': 'Idle · tap to start',
      'surround.pausedHint': 'Paused · tap to resume',
      'surround.startFailed': 'Start failed: @error',
      'menu.tools': 'Tools',
