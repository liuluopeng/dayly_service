...
class _UtilsPageState extends State<UtilsPage> {
  ...
  void _testBase64() {
    setState(() {
      ...
      base64DecodeOutput =
          base64DecodeWasm(input: base64DecodeInput) ??
          'base64.decodeFailed'.tr;
    });
  }
            ...
            children: [
              ...
              _buildSection('utils.base64Section'.tr, [
                TextField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'utils.inputString'.tr,
                  ),
                ),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'utils.base64String'.tr,
                  ),
                ),
                const SizedBox(height: 8),
                Text(
                  'utils.decodeResult'.trParams({'value': base64DecodeOutput}),
                ),
              ]),
              ...
              _buildSection('utils.passwordSection'.tr, [
                TextField(
                  ...
                  keyboardType: TextInputType.number,
                  decoration: InputDecoration(
                    labelText: 'utils.passwordLength'.tr,
                  ),
                ),
                const SizedBox(height: 16),
                Text(
                  'utils.randomPassword'.trParams({'value': passwordResult}),
                ),
                Text(
                  'utils.strongPassword'.trParams({
                    'value': strongPasswordResult,
                  }),
                ),
              ]),
              ...
              _buildSection('utils.timestampSection'.tr, [
                Text(
                  'utils.currentTimestamp'.trParams({
                    'value': currentTimestamp,
                  }),
                ),
                Text(
                  'utils.currentLocalTime'.trParams({
                    'value': currentLocalTime,
                  }),
                ),
                Text(
                  'utils.currentUtcTime'.trParams({'value': currentUTCTime}),
                ),
                ElevatedButton(
