...
class LdoceDictPage extends StatefulWidget {
  ...
  @override
  State<LdoceDictPage> createState() => _LdoceDictPageState();
}

class _LdoceDictPageState extends State<LdoceDictPage> {
  ...
  Future<void> _searchWord() async {
    ...
    try {
      final htmlContent = await searchLdoceForDart(word: word);
...
<body>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CommonAppBar(title: 'ldoce.title'.tr),
      body: SafeArea(
        child: Column(
          children: [
            Padding(
