...
#[wasm_bindgen]
pub fn get_word_count() -> usize { WORD_COUNT }
#[wasm_bindgen]
pub fn get_entry_size() -> usize { ENTRY_SIZE }
...
pub fn get_explanation_for_word(index: usize) -> JsValue {
    ...
    let idx_off = index * 8;
    let offset = u32::from_le_bytes(EXPLANATION_INDEX[idx_off..idx_off+4].try_into().unwrap()) as usize;
    let length = u32::from_le_bytes(EXPLANATION_INDEX[idx_off+4..idx_off+8].try_into().unwrap()) as usize;
