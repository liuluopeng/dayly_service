...
pub fn game2048_init() {
    GAME.with(|g| *g.borrow_mut() = Game2048::new());
}
...
pub fn game2048_score() -> u32 {
    GAME.with(|g| g.borrow().score as u32)
}

#[wasm_bindgen]
pub fn game2048_max_tile() -> u32 {
    GAME.with(|g| g.borrow().max_tile())
}
...
pub fn game2048_move(dir: &str) -> bool {
    GAME.with(|g| g.borrow_mut().move_dir(dir))
}

#[wasm_bindgen]
pub fn game2048_undo() -> bool {
    GAME.with(|g| g.borrow_mut().undo())
}
