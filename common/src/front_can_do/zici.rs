//! 字词学习数据（生字表/生词表）——从 Vue 端提取，供 Flutter/Vue/wasm-demo 共享
//! 生字：小学 1-6 年级 12 段；生词：2182 个常用词

pub static NEW_CHARS_DATA: [&str; 12] = [
...
pub static NEW_WORDS_DATA: [&str; 2182] = [
    "看见",
    "哪里",
    "那边",
    "头顶",
...
pub fn new_chars_for_grade(grade: usize, term: usize) -> Vec<char> {
    ...
    NEW_CHARS_DATA[index].chars().collect()
}
